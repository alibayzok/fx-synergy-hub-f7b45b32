    ...
    const response = await fetch(endpoint, {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { 
            role: "system", 
            content: settingsMap['ai_system_prompt'] || `أنت مساعد ذكي لمنصة تداول ASSASSIN FX. تساعد المستخدمين في الإجابة على أسئلة التداول والفوركس والعملات الرقمية. كن ودوداً ومفيداً وأجب باللغة العربية إلا إذا سألك المستخدم بالإنجليزية.`
          },
          ...messages,
        ],
        stream: true,
