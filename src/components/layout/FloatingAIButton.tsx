...
const socialLinks = [
  {
    ...
    url: 'https://wa.me/message/YOURLINK',
    icon: (
  ...
  },
  {
    ...
    url: 'https://t.me/assaisn_syria_forex_signal',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-white">
  ...
  },
  {
    ...
    url: 'https://www.facebook.com/share/1FRW6i4vUZ/',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-white">
  ...
  },
  {
    ...
    url: 'https://www.instagram.com/forex_assassin33?igsh=bGtmMmw2c3dmdWc2',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-white">
      ...
      <AnimatePresence>
        {isOpen && menuItems.map((item, index) => (
          <motion.button
            ...
            style={{ bottom: `${84 + (index + 1) * 56}px` }}
          >
            <motion.span
              initial={{ opacity: 0, x: 10 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ delay: index * 0.05 + 0.1 }}
              className="px-3 py-1.5 rounded-lg bg-card border border-border/30 text-xs font-medium text-foreground shadow-lg whitespace-nowrap"
            >
              {item.label}
            </motion.span>
            <div className={cn(
              "w-11 h-11 rounded-full flex items-center justify-center shadow-lg bg-gradient-to-br",
