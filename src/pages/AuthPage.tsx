                    ...
                    <>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <Button type="button" variant="outline"
                          className="w-full h-11 rounded-xl gap-2 bg-white/[0.03] border-white/[0.08] text-white/70 hover:bg-white/[0.06] hover:text-white transition-all"
                          onClick={() => {
                            toast({ title: 'قريباً', description: 'تسجيل الدخول عبر Facebook سيتوفر قريباً' });
                          }}>
                          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none">
                            ...
                            <path d="M16.6711 15.4688L17.2031 12H13.875V9.75C13.875 8.80102 14.34 7.875 15.8306 7.875H17.3438V4.92188C17.3438 4.92188 15.9705 4.6875 14.6576 4.6875C11.9166 4.6875 10.125 6.34875 10.125 9.35625V12H7.07812V15.4688H10.125V23.8542C10.7359 23.9514 11.3621 24.0001 12 24.0001C12.6379 24.0001 13.2641 23.9514 13.875 23.8542V15.4688H16.6711Z" fill="white"/>
                          </svg>
                          Facebook
                        </Button>
                      </div>
